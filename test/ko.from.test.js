...
exports.from = function (t) {
  ...
  t.deepEqual(k2.players(), [9,10,11,12,13,14,15,16], "advancers from k1");
  var k2m1 = k2.matches[0];
  t.deepEqual(k2m1.p, [16,15,14,13,12,11,10,9], "all in k2 m0");
  k2.score(k2m1.id, $.range(8).reverse()); // maintain current order
  var top4 = $.pluck('seed', k2.results().slice(0, 4));
  t.deepEqual(top4, [16,15,14,13], "winners top 4 in k2");
